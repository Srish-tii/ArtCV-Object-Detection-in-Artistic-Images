...
All model training is performed on the datasets generated using the various style transfer techniques mentioned above. 
Evaluation is performed on the PeopleArt (Cai et al. 2015) dataset which consists of a set of ~5000 images of artwork in which people have been labelled with bounding boxes. The dataset includes a training set, a validation set and a test set.
...
Cai, Q. Wu, T. Corradi, and P. Hall, “The Cross-Depiction Problem: Computer Vision Algorithms for Recognising Objects in Artwork and in Photographs,” may 2015, arXiv:1505.00110.
